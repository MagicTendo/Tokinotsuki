...
const artefactTable = {
    ...
    "Un|Le|Yatosa": { probability: 1, color: [166, 110, 50], emoji: "🪙", shadow: "❔", name: "yatosa", price: 10_000 },
...
const birdTable = {
    ...
    "Une|La|photo d'un sanikitsu": { probability: 10, color: [107, 20, 0], emoji: "🕘️", shadow: "❔", name: "sanikitsu", currency: "cookie", price: 25 },
